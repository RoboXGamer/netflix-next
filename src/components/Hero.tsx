...
const Hero = () => {
  return (
    <div className="relative min-h-[80vh] flex items-center justify-center overflow-hidden w-full bg-linear-to-br from-black via-gray-900 to-black">
      <Image
        width={1920}
        height={1080}
      ...
      <div
        aria-hidden="true"
        className="absolute inset-0 bg-linear-to-br from-black/95 via-black/70 to-black/95 pointer-events-none"
      />
